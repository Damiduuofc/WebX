    ...
    <div className="w-full max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8 space-y-12 sm:space-y-16">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#192841]/5 border border-[#192841]/15 text-[#192841] text-xs font-semibold tracking-wide">
          <Compass size={13} className="text-[#192841]" />
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        {[
          ...
          <div
            key={idx}
            className="bg-white rounded-2xl border border-[#D6DAE3] p-6 text-center shadow-[0_4px_14px_rgba(25,40,65,0.06)]"
          >
            <div className="text-3xl sm:text-4xl font-extrabold text-[#192841] tracking-tight">
              {item.metric}
            </div>
      ...
      <div className="bg-white rounded-2xl border border-[#D6DAE3] p-6 sm:p-10 shadow-[0_4px_20px_rgba(25,40,65,0.08)] space-y-8">
        <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 rounded-xl bg-[#F7F8FA] border border-[#D6DAE3]/70 space-y-2">
            <div className="flex items-center gap-3">
              <span className="w-8 h-8 rounded-lg bg-[#192841] text-white flex items-center justify-center font-bold text-sm">
                1
              </span>
              <h3 className="font-bold text-[#192841] text-base">One Accent Color</h3>
            </div>
            <p className="text-xs sm:text-sm text-[#5A6B85] leading-relaxed pl-11">
              Deep Navy (<code className="text-[#192841] font-mono text-xs bg-white px-1.5 py-0.5 rounded border border-[#D6DAE3]">#192841</code>) carries all brand identity and primary interactive focus. Everything else is pure black for text and crisp white/off-white for high readability.
            </p>
          </div>
          ...
          <div className="p-6 rounded-xl bg-[#F7F8FA] border border-[#D6DAE3]/70 space-y-2">
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-bold text-[#192841] text-base">Function Over Decoration</h3>
            </div>
            <p className="text-xs sm:text-sm text-[#5A6B85] leading-relaxed pl-11">
          ...
          <div className="p-6 rounded-xl bg-[#F7F8FA] border border-[#D6DAE3]/70 space-y-2">
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-bold text-[#192841] text-base">Breathing Room</h3>
            </div>
            <p className="text-xs sm:text-sm text-[#5A6B85] leading-relaxed pl-11">
          ...
          <div className="p-6 rounded-xl bg-[#F7F8FA] border border-[#D6DAE3]/70 space-y-2">
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-bold text-[#192841] text-base">Predictable Consistency</h3>
            </div>
            <p className="text-xs sm:text-sm text-[#5A6B85] leading-relaxed pl-11">
      ...
      <div className="space-y-6">
        <div>
          <h2 className="text-2xl sm:text-3xl font-extrabold text-[#192841]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-2xl border border-[#D6DAE3] p-6 shadow-[0_2px_10px_rgba(25,40,65,0.04)] space-y-3">
            <div className="w-10 h-10 rounded-xl bg-[#192841] text-white flex items-center justify-center">
              <Train size={20} />
            </div>
            <h3 className="font-bold text-[#192841] text-lg">Metropolitan Rail</h3>
          ...
          <div className="bg-white rounded-2xl border border-[#D6DAE3] p-6 shadow-[0_2px_10px_rgba(25,40,65,0.04)] space-y-3">
            ...
            <h3 className="font-bold text-[#192841] text-lg">City & Feeder Buses</h3>
            <p className="text-xs sm:text-sm text-[#5A6B85] leading-relaxed">
          ...
          <div className="bg-white rounded-2xl border border-[#D6DAE3] p-6 shadow-[0_2px_10px_rgba(25,40,65,0.04)] space-y-3">
            ...
            <h3 className="font-bold text-[#192841] text-lg">Pedestrian Linkways</h3>
            <p className="text-xs sm:text-sm text-[#5A6B85] leading-relaxed">
      ...
      <div className="bg-[#192841] text-white rounded-2xl p-8 sm:p-12 shadow-[0_8px_30px_rgba(25,40,65,0.18)] flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
          <Link
            href="/"
            className="px-6 py-3 rounded-xl bg-white text-[#192841] hover:bg-[#F7F8FA] font-bold text-sm text-center transition-colors shadow-sm"
          >
            Plan a Journey
          </Link>
          <Link
